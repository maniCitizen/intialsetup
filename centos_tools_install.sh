...
tmux_install()
{
    ...
    sudo yum install -y tmux &>>${LOGFILE}
...
trash_cli_install()
{
    ...
    sudo yum install -y trash-cli &>>${LOGFILE}
...
ranger_install()
{
    ...
    sudo yum install -y ranger &>>${LOGFILE}
...
asciinema_install()
{
    ...
    sudo yum install -y asciinema &>>${LOGFILE}
...
{
    echo "Coming soon!!!"
#    sudo yum install -y filebrowser &>>${LOGFILE}
